...
var file_greeter_proto_rawDesc = []byte{
	...
	,
...
var file_greeter_proto_depIdxs = []int32{
	1, // 0: proto.GreeterService.Greet:input_type -> proto.Empty
	0, // 1: proto.GreeterService.Greet:output_type -> proto.GreetResponse
...
func (c *greeterServiceClient) Greet(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/proto.GreeterService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGreeterServiceServer) Greet(context.Context, *Empty) (*GreetResponse, error) {
...
func _GreeterService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.GreeterService/Greet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServiceServer).Greet(ctx, req.(*Empty))
	}
